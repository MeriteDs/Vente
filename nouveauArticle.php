...
<body>
    ...
    <div class="container col-sm-offset-3 col-sm-6 col-sm-offset-3" id="vers">
        <div id="card">
            <a href="listeCommande.php"><button class="btn btn-success" style="width:100%;"><img id="icommande" src="assets/menu2.png">&nbsp;Voir les commendes en attente de livraison </button></a>
        </div>
    </div>
   ...
   <div id="card">
       <div class="card-header">
        ...
        <form action="ajoutArticle.php" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success" style="width: 100%;"><img id='icommande' src='assets/valider2.png'>&nbsp;Ajouter</button>
        </form>
       </div>
   </div>
</div>
